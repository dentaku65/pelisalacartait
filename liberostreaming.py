...
def mainlist(item):
    logger.info("pelisalacarta.liberostreaming mainlist")
    itemlist = []
    itemlist.append( Item(channel=__channel__, title="[COLOR azure]Novita'[/COLOR]", action="peliculas", url="http://liberostreaming.org/", thumbnail="http://dc584.4shared.com/img/XImgcB94/s7/13feaf0b538/saquinho_de_pipoca_01"))
    ...
    itemlist.append( Item(channel=__channel__, title="[COLOR azure]Serie TV[/COLOR]", action="peliculas", url="http://www.liberostreaming.org/category/telefilm/", thumbnail="http://dc584.4shared.com/img/XImgcB94/s7/13feaf0b538/saquinho_de_pipoca_01"))
    itemlist.append( Item(channel=__channel__, title="[COLOR azure]Anime[/COLOR]", action="peliculas", url="http://www.liberostreaming.org/category/anime/", thumbnail="http://dc584.4shared.com/img/XImgcB94/s7/13feaf0b538/saquinho_de_pipoca_01"))
...
def categorias(item):
    logger.info("pelisalacarta.liberostreaming categorias")
    itemlist = []
...
def peliculas(item):
    logger.info("pelisalacarta.liberostreaming peliculas")
    itemlist = []
