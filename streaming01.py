...
def mainlist(item):
    logger.info("pelisalacarta.streaming01 mainlist")
    itemlist = []
    itemlist.append( Item(channel=__channel__, title="[COLOR azure]Ultimi Film Inseriti[/COLOR]", action="peliculas", url="http://www.streaming01.com/", thumbnail="http://dc584.4shared.com/img/XImgcB94/s7/13feaf0b538/saquinho_de_pipoca_01"))
    itemlist.append( Item(channel=__channel__, title="[COLOR azure]Film Per Categoria[/COLOR]", action="categorias", url="http://www.streaming01.com/", thumbnail="http://xbmc-repo-ackbarr.googlecode.com/svn/trunk/dev/skin.cirrus%20extended%20v2/extras/moviegenres/All%20Movies%20by%20Genre.png"))
...
def search(item,texto):
    ...
    item.url = "http://www.streaming01.com/index.php?do=search&subaction=search&story="+texto
    try:
...
def peliculas(item):
    logger.info("pelisalacarta.streaming01 peliculas")
    itemlist = []
