...
def mainlist(item):
    ...
    itemlist.append( Item(channel=__channel__, action="listaaz"  , title="[COLOR azure]Anime - Lista A-Z[/COLOR]" , url="http://www.cineblog01.cc/anime/lista-completa-anime-cartoon/" , thumbnail="http://i.imgur.com/IjCmx5r.png"))
