...
########## Start ITALIAN CHANNELS ###########
    ...
    itemlist.append( Item( title="[COLOR red][DEV][/COLOR]ItaFilm.tv (IT)"      , channel="itafilmtv"           , language="IT"    , category="F,S,A,D"   , type="generic"  ,thumbnail="http://www.itafilm.tv/templates/monsterfilm/images/logo.png"   ))
    itemlist.append( Item( title="[COLOR red][DEV][/COLOR] Tantifilm (IT)"        , channel="tantifilm"       , language="IT"    , category="F"       , type="generic"     ,thumbnail="http://www.tantifilm.net/wp-content/themes/smashingMultiMediaBrown/images/logo.png"))
    ...
    itemlist.append( Item( title="[COLOR red][DEV][/COLOR] Documentaristreaming (IT)"          , channel="documentaristreaming"         , language="IT" , category="F,D"        , type="generic" , extra="Series" ,thumbnail="http://tvstreamingonline.org/images/IMG/documentari%20streaming.jpg"))##### End ITALIAN CHANNELS ######
