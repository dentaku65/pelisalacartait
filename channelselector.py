...
def channels_list():
    ...
    itemlist.append( Item( title="[COLOR orange][TEST][/COLOR] Eurostreaming (IT)"        , channel="eurostreaming"       , language="IT"    , category="S"       , type="generic"     ,thumbnail="http://eurostreaming.tv/wp-content/uploads/2014/03/logo2.png"))
