...
########## Start ITALIAN CHANNELS ###########
    ...
    itemlist.append( Item( title="[COLOR orange][NEW][/COLOR] FilmStream pw (IT)"        , channel="filmstreampw"       , language="IT"    , category="S"        , type="generic" , extra="Series" ,thumbnail="http://www.guardaserie.net/wp-content/themes/guardaserie/images/new_logo.png"))
