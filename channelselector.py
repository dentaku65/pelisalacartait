...
def channels_list():
    ...
    itemlist.append( Item( title="Bricocine"       , channel="bricocine"             , language="ES"      , category="F,S" , type="generic" , thumbnail="http://s6.postimg.org/9u8m1ep8x/bricocine.jpg"    ))
    ...
    itemlist.append( Item( title="[COLOR orange][TEST][/COLOR] Casa-cinema (IT)"        , channel="casacinema"       , language="IT"    , category="F,S"       , type="generic"     ,thumbnail="http://casa-cinema.net/wp-content/themes/casacinema/images/logo-Black.png"))
    itemlist.append( Item( title="[COLOR orange][TEST][/COLOR] Tantifilm (IT)"        , channel="tantifilm"       , language="IT"    , category="F"       , type="generic"     ,thumbnail="http://www.tantifilm.net/wp-content/themes/smashingMultiMediaBrown/images/logo.png"))
    itemlist.append( Item( title="[COLOR orange][TEST][/COLOR] Streamingfilm (IT)"        , channel="streamingfilm"       , language="IT"    , category="F"       , type="generic"     ,thumbnail="http://www.streamingfilm.tv/assets/images/logo.png"))
    itemlist.append( Item( title="Eurostreaming (IT)"        , channel="eurostreaming"       , language="IT"    , category="F,S,A,VOS"       , type="generic"     ,thumbnail="http://eurostreaming.tv/wp-content/uploads/2014/03/logo2.png"))
    itemlist.append( Item( title="[COLOR orange][NOT READY][/COLOR] Altadefinizione (IT)"        , channel="altadefinizione"       , language="IT"    , category="F"       , type="generic"     ,thumbnail="http://altadefinizione.click/wp-content/themes/hd/img/logo.png"))
    ...
    itemlist.append( Item( title="SeriesMu"       , channel="seriesmu"           , language="ES"    , category="F,S,A,VOS"   , type="generic"  ))
    ...
    itemlist.append( Item( title="Serie TV Sub ITA (IT)"          , channel="serietvsubita"         , language="IT" , category="S"        , type="generic" , extra="Series" ,thumbnail="http://serietvsubita.net/wp-content/uploads/2012/07/Header2.png"))
    itemlist.append( Item( title="[COLOR orange][TEST][/COLOR] Italiaserie (IT)"          , channel="italiaserie"         , language="IT" , category="S"        , type="generic" , extra="Series" ,thumbnail="http://www.italiaserie.com/wp-content/uploads/2015/03/logo.png"))
    ...
    itemlist.append( Item( title="Sonolatino"            , channel="sonolatino"           , language="ES"   , category="M"          , type="xbmc"  ))
    itemlist.append( Item( title="Stagevu"               , channel="stagevusite"          , language="ES"   , category="G"          , type="xbmc"  ))
