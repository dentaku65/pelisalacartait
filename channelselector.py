...
########## Start ITALIAN CHANNELS ###########
    ...
    itemlist.append( Item( title="[COLOR orange][NEW][/COLOR] Streamblog (IT)"       , channel="stramblog"           , language="IT"    , category="F,S,A"   , type="generic", thumbnail="http://www.streamblog.tv/templates/Smotrikino/images/logo.png"  ))
