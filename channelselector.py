...
def channels_list():
    ...
    #itemlist.append( Item( title="[COLOR orange][NEW][/COLOR] FilmstreamPW (IT)"        , channel="filmstreampw"       , language="IT"    , category="F"       , type="generic"     ,thumbnail="http://filmstream.pw/templates/tvspirit/images/logo.png"))
