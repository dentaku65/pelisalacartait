...
def channels_list():
    ...
    itemlist.append( Item( title="[COLOR orange][TEST][/COLOR] Film-stream.org (IT)"        , channel="filmstream"       , language="IT"    , category="F,S"       , type="generic"     ,thumbnail="http://static.rank-bank.com.s3-website-eu-west-1.amazonaws.com/it/answer/d3/d3e35908087eee0800c4530728543ffd/large.jpg"))
    itemlist.append( Item( title="Eurostreaming (IT)"        , channel="eurostreaming"       , language="IT"    , category="S"       , type="generic"     ,thumbnail="http://eurostreaming.tv/wp-content/uploads/2014/03/logo2.png"))
