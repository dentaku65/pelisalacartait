...
########## Start ITALIAN CHANNELS ###########
    ...
    itemlist.append( Item( title="[COLOR red][DEV][/COLOR] Altadefinizione.click (IT)"          , channel="altadefinizioneclick"         , language="IT" , category="F,S,A"        , type="generic", thumbnail="http://altadefinizione.click/wp-content/themes/hd/img/logo.png"))
