...
########## Start ITALIAN CHANNELS ###########
    ...
    itemlist.append( Item( title="[COLOR red][DEV][/COLOR] Liberostreaming (IT)"          , channel="liberostreaming"         , language="IT" , category="F,S,A"        , type="generic", thumbnail="http://www.liberostreaming.org/wp-content/uploads/2015/01/cooltext1859870362.png"))
